...
This project uses Supabase (cloud PostgreSQL) as the database to store faculty information, publications, and research metrics. The database schema is designed based on the ER diagram and implemented using Django models.
